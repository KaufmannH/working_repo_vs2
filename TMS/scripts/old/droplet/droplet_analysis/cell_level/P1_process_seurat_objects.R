...
lung_male <- readRDS("droplet/cell_level/processed_10_22/3m/Lung_3m_male_processed.rds") 
lung_female <- readRDS("droplet/cell_level/processed_10_22/3m/Lung_3m_female_processed.rds")
lung_female
main_seurat <- merge(lung_female, y = lung_male, add.cell.ids = c("lung_female", "lung_male"))



path <- "droplet/cell_level/processed_10_22/3m"
...
# save
#saveRDS(main_seurat, "droplet_analysis/data/fused_seurat_droplet_3m.rds")
...
#saveRDS(immune_seurat, "droplet_analysis/data/immune_seurat_droplet_3m.rds")
